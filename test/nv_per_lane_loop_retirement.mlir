// Run with the plugin loaded (needs a TRITON_EXT_ENABLED libtriton):
// RUN: TRITON_PLUGIN_PATHS=%plugin_lib triton-opt %s -split-input-file -nv-per-lane-loop-retirement -verify-diagnostics | FileCheck %s
